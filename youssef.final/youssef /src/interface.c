...
create_stat (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed5), label01, 184, 152);
  gtk_widget_set_size_request (label01, 208, 40);

  label02 = gtk_label_new ("");
  gtk_widget_show (label02);
  gtk_fixed_put (GTK_FIXED (fixed5), label02, 184, 192);
  gtk_widget_set_size_request (label02, 208, 40);
  ...
  GLADE_HOOKUP_OBJECT (stat, label02, "label02");
